...
\begin{align}
           = p(X_2=0|X_1=0) = \frac{1}{2}\times\frac{2}{8}\div\frac{1}{2}
                        = \frac{1}{4}
\end{align} 
Probability of choosing consecutive letters TA from CALCUTTA:
\begin{align}
           = p(X_2=1|X_1=1) = \frac{1}{2}\times\frac{1}{7}\div\frac{1}{2}
                        = \frac{1}{7}
\end{align}                  
By using bayes theorem, we get the probability of getting two consecutive letters TA from TATANAGAR:\\
\begin{align}
&= \{p_{X_1}\brak{0}p(X_2=0|X_1=0)\}\div\{p_{X_1}\brak{0}p(X_2=0|X_1=0)+ p_{X_2}\brak{1}p(X_2=1|X_1=1)\}\\
